...
//  BBosong
//
//  Created by 김미진 on 12/5/23.
//

import Foundation
import UIKit

@IBDesignable class ProgressButton: FancyButton {
    private let inProgressView = UIView()
    private let indicatorView = UIActivityIndicatorView(style: UIActivityIndicatorView.Style.large)
